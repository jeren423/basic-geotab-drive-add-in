 ...
 */
geotab.addin.protoPhone = function (api, state, meta) {
  'use strict';
  const appName = 'protoPhone';
  const addinId = 'azA3ZTNiZjMtOTQyMC03Mzd';
  let reactRoot;
  
  // the root container
  
  var elAddin = document.getElementById('protoPhone-app');
