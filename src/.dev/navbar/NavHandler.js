class NavHandler {
    ...
    */
    generateContent(){
        ...
        let centerPane            = document.getElementById('protoPhone');
    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.protoPhone.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.protoPhone.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'protoPhone'){
                    geotab.addin.protoPhone.blur();
                } else {
                    geotab.addin.protoPhone.focus(global.api, global.state);
                }
            }
        }, 100);
    }
